...
def anneal(tasks, solution, randomness = 0, toggle = False, i_c = 0):
    ...
    while len(unused) > 0 and len(locations_to_try) > 0:
        ...
        for task_id in unused:
            ...
            if  total_computed > value_original or ((toggle and random.randint(0, 800) > i_c) and (total_computed/value_original  > (i_c)/(i_c+3))):
    ...
    for i in range(len(solution_swap)):
        for j in range(len(solution_swap)):
            ...
            if total_computed > value_original or ((toggle and random.randint(0, 800) > i_c) and (total_computed/value_original  > (i_c+1)/(i_c+3))):
...
def run_trial(trial_name, c1 = 0, c2 = 0, c3 = 0):
    tasks = read_input_file("/Users/samuelspeas/Desktop/cs170/project/CS170_project/outputs/" + trial_name)
...
def run_anneal(trial_name, iterations, verbose = True, c1 = 0, c2 = 0, c3 = 0):
    ...
    tasks = read_input_file("/Users/samuelspeas/Desktop/cs170/project/CS170_project/inputs/" + trial_name)
    ...
    for i in range(iterations):
        output = anneal(tasks, output, 0, toggle, i)
        if verbose:
            print(i, compute_total(tasks, output))
    ...
    if verbose:
        t = compute_total(tasks, output) 
        print("final value: ", t)
        print("improvement from greedy: ", t - compute_total(tasks, greedy_output))
    return output

def run_anneal_all(size, iterations = 1250, c1 = 0, c2 = 0, c3 = 0):
    average = 0
    count = 0
    for input_path in os.listdir("/Users/samuelspeas/Desktop/cs170/project/CS170_project/inputs/" + size):
        tasks = read_input_file("/Users/samuelspeas/Desktop/cs170/project/CS170_project/inputs/" + size + input_path)
        ...
        output_path = "/Users/samuelspeas/Desktop/cs170/project/CS170_project/outputs/" + size + input_path[:-3] + '.out'
        write_output_file(output_path, output)
    return average/count


# RUNNING THE SOLVER
directory = "/Users/samuelspeas/Desktop/cs170/project/CS170_project/inputs/"
input_100 = "small/"
input_150 = "medium/"
input_200 = "large/"
